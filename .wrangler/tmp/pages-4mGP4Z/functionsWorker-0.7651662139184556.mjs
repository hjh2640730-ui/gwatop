...
async function getFirebaseAccessToken(clientEmail, privateKey) {
  ...
  const encode = /* @__PURE__ */ __name((obj) => btoa(JSON.stringify(obj)).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, ""), "encode");
...
async function verifyFirebaseToken2(idToken) {
  try {
    ...
    const decode = /* @__PURE__ */ __name((b64) => JSON.parse(new TextDecoder().decode(
...
__name(getFirebaseAccessToken5, "getFirebaseAccessToken");
...
__name(verifyFirebaseToken4, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken6, "getFirebaseAccessToken");
...
__name(getFirebaseAccessToken7, "getFirebaseAccessToken");
...
__name(verifyFirebaseToken5, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken8, "getFirebaseAccessToken");
...
__name(getFirebasePublicKeys2, "getFirebasePublicKeys");
var CORS10 = {
  "Access-Control-Allow-Origin": "*",
  "Access-Control-Allow-Methods": "POST, OPTIONS",
  "Access-Control-Allow-Headers": "Content-Type, Authorization",
...
__name(verifyFirebaseToken6, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken9, "getFirebaseAccessToken");
...
__name(getFirebasePublicKeys3, "getFirebasePublicKeys");
var CORS11 = {
  "Access-Control-Allow-Origin": "*",
  "Access-Control-Allow-Methods": "POST, OPTIONS",
  "Access-Control-Allow-Headers": "Content-Type, Authorization",
...
__name(verifyFirebaseToken7, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken10, "getFirebaseAccessToken");
...
__name(getFirebaseAccessToken11, "getFirebaseAccessToken");
...
__name(getFirebasePublicKeys4, "getFirebasePublicKeys");
...
__name(verifyFirebaseToken8, "verifyFirebaseToken");
...
__name(verifyFirebaseToken9, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken12, "getFirebaseAccessToken");
...
__name(commitWrites2, "commitWrites");
...
__name(verifyFirebaseToken10, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken13, "getFirebaseAccessToken");
...
__name(commitWrites3, "commitWrites");
...
__name(getFirebasePublicKeys5, "getFirebasePublicKeys");
...
__name(verifyFirebaseToken11, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken14, "getFirebaseAccessToken");
...
__name(verifyFirebaseToken12, "verifyFirebaseToken");
...
__name(verifyFirebaseToken13, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken16, "getFirebaseAccessToken");
...
__name(verifyFirebaseToken14, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken17, "getFirebaseAccessToken");
...
__name(verifyFirebaseToken15, "verifyFirebaseToken");
...
__name(getFirebaseAccessToken18, "getFirebaseAccessToken");
...
// ../.wrangler/tmp/pages-4mGP4Z/functionsRoutes-0.8891999224439266.mjs
var routes = [
  {
    routePath: "/api/admin",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-NDEjLJ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-NDEjLJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7651662139184556.mjs.map
